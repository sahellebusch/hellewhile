(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hellewhile"] = factory();
	else
		root["hellewhile"] = factory();
 ...
 */
var hellewhile = function hellewhile(asyncFn, predicate) {
  var context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var tracker = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;

  if (context && tracker && !context[tracker]) {
    context = Object.assign({}, context, _defineProperty({}, tracker, []));
  }

  return asyncFn(context).then(function (res) {
    if (context && tracker) {
      context[tracker] = _toConsumableArray(context[tracker]).concat([res]);
    }

    return predicate(res, context) ? Promise.resolve(context) : hellewhile(asyncFn, predicate, context, tracker);
  });
};

var _default = hellewhile;
exports.default = _default;

/***/ })
/******/ ]);
});
//# sourceMappingURL=hellewhile.js.map