 ...
 */
var hellewhile = exports.hellewhile = function hellewhile(asyncFn, predicate) {
  ...
  return asyncFn(context).then(function (res) {
    if (context && tracker) {
      context[tracker] = [].concat(_toConsumableArray(context[tracker]), [res]);
    }
